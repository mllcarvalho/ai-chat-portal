...
import type { AgentPreset, SessionMode } from '@aiportal/shared';
...
export function AgentsManager() {
  ...
  return (
    <Modal title={draft ? (draft.id ? 'Editar agente' : 'Novo agente') : 'Agentes'} wide>
      {draft ? (
        <>
          <div className="row">
        ...
        <>
          ...
          {agents.length === 0 && (
            <div className="empty-state">
              Agentes são presets de instruções + modelo + modo que você aplica a uma conversa.
            </div>
          )}
